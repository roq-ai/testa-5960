...
import { getNeuralNetworkById } from 'apiSdk/neural-networks';
import { NeuralNetworkInterface } from 'interfaces/neural-network';
import { TrainingDataListPage } from 'pages/training-data';

function NeuralNetworkViewPage() {
