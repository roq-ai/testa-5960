...
import { getTrainingDataById } from 'apiSdk/training-data';
import { TrainingDataInterface } from 'interfaces/training-data';

function TrainingDataViewPage() {
              ...
              >
                ...
                {hasAccess('neural_network', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/neural-networks/view/${data?.neural_network?.id}`}>
                        {data?.neural_network?.name}
                      </Link>
                    }
                  />
                )}
